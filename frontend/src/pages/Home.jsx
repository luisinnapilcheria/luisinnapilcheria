          ...
          <div className="md:text-right space-y-2">
            ...
            <div className="flex md:justify-end items-center">
              <a 
                ...
                target="_blank" 
                rel="noreferrer" 
                className="inline-flex items-center gap-2 bg-gradient-to-r from-rose-500 via-purple-500 to-amber-500 text-white px-3 py-1.5 rounded-full text-xs font-semibold hover:opacity-90 transition shadow-xs group"
              >
